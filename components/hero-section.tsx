...
export default function HeroSection() {
  return (
    <>
      <HeroHeader />
      <main className="overflow-hidden hero-bg  ">
        <div
          aria-hidden
        ...
        <section>
          <div className="relative pt-36 md:pt-62">
            <div
              aria-hidden
  ...
  "
                ...
                >
                  ...
                  helping brides shine with unmatched grace and
                  sophistication—without the burden of ownership.
                </TextEffect>
