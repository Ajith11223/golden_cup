        ...
        <footer className="border-b  pt-20 dark:bg-transparent">
            <div className="mb-8 border-b md:mb-12">
                <div className="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-6 px-6 pb-6">
                    ...
                    <Link
                            href="https://www.instagram.com/goldencup_rental_jewellery/?hl=en"
                            target="_blank"
            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
                    <small className="text-muted-foreground order-last block text-center text-sm md:order-first">© {new Date().getFullYear()} Golden Cup, All rights reserved</small>
                    <form action="">
