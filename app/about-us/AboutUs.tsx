...
const AboutUs = () => {
  return (
    <div>
      <div
        className="relative overflow-hidden z-0 bg-[linear-gradient(135deg,_#001e1e_0%,_#003f3f_35%,_#4f7f6a_70%,_#6b8f75_100%)]
"
      >
        ...
        <div className="pt-[110px] md:pt-[100px] xl:pt-[120px] mt-3 flex flex-col gap-10 md:gap-16 xl:gap-[80px]">
          <div className="Common-padding flex flex-col items-center">
            ...
            <div className="w-full max-w-[1700px] flex flex-col gap-10 md:gap-16 xl:gap-[80px]">
              <div className="flex flex-col sm:flex-row gap-5 md:gap-[30px] sm:items-center sm:justify-between ">
                <div className="flex flex-col gap-5 lg:gap-[30px]">
                  ...
                  <p className="w-full sm:w-[300px] md:w-[340px] lg:w-[380px] xl:w-[500px]    pr-[5%] sm:pr-[0%]">
                    ...
                    construction sectors. Our portfolio includes premium rental
                    jewellery, bridal outfit rentals, women's garment retail,
                    proprietary women's clothing brands, and comprehensive
                    construction services. Through a customer-centric approach
                    and unwavering commitment to quality standards, Golden Cup
                    Group continues to achieve steady growth throughout the
                    state.{" "}
                  </p>
                </div>
              ...
              <div className="bg-[linear-gradient(135deg,_#004d4d_65%,_#6b8f75_100%,_#003737_40%,_#001e1e_10%)] py-8 md:py-10 xl:py-[60px]  px-3 sm:px-5 md:px-[30px] lg:px-[50px] xl:px-[60px] flex flex-row items-center justify-between gap-7 lg:gap-[40px] md:flex-row gap-[30px] items-center 
          ...
          <div className="relative  overflow-hidden z-0  ">
            <div className=" py-8 md:py-10 xl:py-[60px] bg-background  px-3 sm:px-5 md:px-[30px] lg:px-[50px] xl:px-[60px] flex flex-col items-center
                ...
                <div className="w-full max-w-[1700px] flex flex-col xl:flex-row gap-5 md:gap-[30px] items-center justify-between ">
                  <div className="xl:w-[480px] flex flex-col gap-[14px] items-center xl:items-start">
                    ...
                    <p className="flex flex-col gap-2 font-normal Normal-text text-justify">
                      <span>
                        Golden Cup Group began its journey in 2017 with a clear
                        vision4to build businesses based on quality, trust, and
                        long-term value. From a single premium rental jewellery
                        venture, the group has grown into a multi-entity
                        organization serving customers across Kerala.
                      </span>
                      <span>
                        Our expansion into bridal wear, women's fashion, and
                        construction reflects our commitment to meeting evolving
                        customer needs while maintaining high standards of
                        professionalism and integrity. This growth has been made
                        possible by the trust of our customers, the dedication
                        of our team, and the support of our partners.
                      </span>
                      <span>
                    ...
                    <div className="xl:w-[480px] flex flex-col gap-[14px] items-center xl:items-start order-1 xl:order-2">
                      ...
                      <p className="flex flex-col gap-2 font-normal Normal-text text-justify">
                        ...
                        <span>
                          ...
                          requires discipline, teamwork, and a clear operational
                          strategy.
                        </span>
                        <span>
                          I strongly believe that sustainable growth comes from
                          understanding customer needs, empowering our
                          employees, and maintaining transparency in everything
                          we do. With a growing presence across Kerala, our aim
                          is to further strengthen our brands while maintaining
                          the trust and loyalty we have earned.
                        </span>
                      </p>
                    </div>
                  </div>
